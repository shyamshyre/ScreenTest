...
(function (factory) {
    ...
    $.extend($.fn.modal.Constructor.prototype, {
        ...
        loadImage: function () {
            ...
            //code added
            galleryViewModel.updateSetIndex ( index );
            
            if(galleryViewModel.watObject() == "Album"){
            	galleryViewModel.currComments ( galleryViewModel.albumList()[galleryViewModel.currIndex()].setOfImgs()[index].comments() );
            }else{
            	galleryViewModel.currComments ( galleryViewModel.galleryList()[galleryViewModel.currIndex()].setOfImgs()[index].comments() );
            }
            
            alert("updated set :" + galleryViewModel.currIndex() + " \n img Index : " + galleryViewModel.setIndex()) ;
            //code added
        ...
        hide: function () {
            ...
            //Code added
            galleryViewModel.updateSetIndex(0);
            galleryViewModel.currComments ([]);
            //code added.
